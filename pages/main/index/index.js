...
Page({
    data: {
        ...
        img_title: ['打印机', '餐厅信息', '管理桌码', '菜品管理', '扫码结账', '店铺状态'],
        urls: ['print/print', 'restinfo/restinfo', 'qrcode/qrcode', 'menumanger/menumanger', 'scancodepay/scancodepay', 'reststatus/reststatus'],
        tabs: ["全部订单", "退单", "未结账订单"],
        activeIndex: 0,
        sliderOffset: 0,
        sliderLeft: 0,
